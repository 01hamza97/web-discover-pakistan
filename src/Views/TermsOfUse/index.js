      ...
      return(<>
        ...
        <div className="row">
          ...
          <div className="col-lg-12 col-sm-12">
            ...
            <p> This website ensures use of your data in accordance with our privacy policy and your use of this site is subject to the below mentioned terms and conditions. These Terms constitute a legally binding agreement between you and Discover Pakistan for your usage of the Site and the services that allows for the distribution and reception of video, audio, and other content.</p>
            <p>Do not use the site if you do not agree with any of the terms contained herein:</p>
            
          </div>
          <div className="col-lg-12 col-sm-12">
            <ol className="list-group">
              <li className="list-group-item">These Terms of use apply to the Discover Pakistan websites along with the organization's web pages, mobile applications, blogs, social networks, and/or other features the company provides that is accessed via Personal Computer, mobile phone or any other device(s).</li>
              <li className="list-group-item">The websites are offered by Discover Pakistan. Above mentioned Terms of Use govern your rights and responsibilities in link with the websites that you are accessing. By "access" means that you are using the website by a computer or any other device(s).</li>
              ...
              <li className="list-group-item">Discover Pakistan reserves the right to change, modify, and/or make additions to the terms of use or the privacy policy at any time or date. If you object to any such changes, your sole option will be to stop using the Site</li>
            ...
            <p>The content of the Discover Pakistan site is owned by Discover Pakistan and/or its licensors and are protected by applicable Pakistani and international copyright and other intellectual property laws.</p>
          ...
          <p>Any breach of the above mentioned terms or any unauthorized uses referred to above would constitute an infringement of the copyrights and other proprietary rights of Discover Pakistan and/or its licensors. Discover Pakistan reserves the right to initiate legal proceedings against the offender under applicable laws.</p>
          ...
          <ol className="">
              ...
              <ul className="list">
                <li className="list-group-item">By allowing you to download the Software, Discover Pakistan does not transfer title of that software to you (i.e., you own the medium on which the software is recorded, but the software's owner will retain its full and complete title.</li>

                <li className="list-group-item">You shall not copy, modify, adapt, translate into any language, distribute, or create derivative works based on that software without the prior written consent of Discover Pakistan.</li>
            ...
            <p>Discover Pakistan reserves the right to modify these terms and Conditions at any time. The conditions become effective as published on this site. Should you have any query you can contact us at the below mention address.</p>
