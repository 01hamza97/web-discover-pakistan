    ...
    return (<>
          ...
          <div className="col-lg-6 col-12 m-auto">
            <div className="card card-advertise col-lg-10 col-md-9 col-12 m-auto py-4">
              ...
              <div className="card-body">
                ...
                <p className="mt-4">
                  <u>
                    <a href="/Become-Contributor#" style={{ color: "#19b24b", fontWeight: 500 }}>
                ...
                <div>
                  <p className="mt-5 text-center">
                    <a href="/" style={{ color: "#19b24b", fontWeight: 500 }}>
                      Go to Home Page
                    </a>
                  </p>
                </div>
      ...
      <Modal animation={false} size="lg" aria-labelledby="contained-modal-title-vcenter" show={this.state.UploadModalOpen} onHide={this.closeModal}>
        ...
        <Modal.Body>
          {!isObjEmpty(userData) &&
            <React.Fragment>
              <Jumbotron fluid style={{ backgroundColor: '#a0f0bb', padding: '2rem 1rem' }}>
                <Container>
      ...
      <Modal animation={false} size="lg" aria-labelledby="contained-modal-title-vcenter" centered show={this.state.uploadInfoModal} onHide={this.closeUploadInfoModal}>
        ...
        <Modal.Body>
          <h6>We can't wait to see your best work</h6>
          <p>First, upload images and video that you have created. Then add details and submit your work for review.</p>
          ...
          <h6>Content with people or private property</h6>
          <a style={{ color: "#19b24b" }} href="/Become-Contributor#">Learn about permission and releases</a>
          <h6>Learn about common rejection reasons</h6>
          <a style={{ color: "#19b24b" }} href="/Become-Contributor#">Focus | Exposure | Pixelation | Trademarks</a>
        </Modal.Body>
        <Modal.Footer>
